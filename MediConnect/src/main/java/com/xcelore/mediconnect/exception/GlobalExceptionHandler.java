...
public class GlobalExceptionHandler {
    ...
    /**
     * Handles MediConnectException and returns a ResponseEntity with an ErrorDetail object.
     */
    @ExceptionHandler(MediConnectException.class)
    public ResponseEntity<ErrorDetail> payWithStripeException(MediConnectException ex, WebRequest wr) {
